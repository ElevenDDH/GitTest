...
<!--top-header-->
	...
	<div class="ckeckout">
		<div class="container">
			...
			<div class="in-check" >
				<ul class="unit">
					<li style="padding-left:100px;"><span>商品编号</span></li>
					<li style="padding-left:100px;"><span>商品名称</span></li>		
					<li style="padding-left:100px;"><span>商品图片</span></li>
					<li style="padding-left:100px;"><span>商品价格</span></li>
					<div class="clearfix"> </div>
				</ul>
				<c:forEach items="${searchlist }" var="mf" varStatus="status"> 
				<ul class="cart-header">
						
						<li style="padding-left:100px;"><span class="cost">${mf.id }</span></li>
						
						<li class="ring-in" style="padding-left:100px;">
						<a href="goodsDetail?id=${mf.id}" >
						<img src="images/logos/${mf.gpicture }" title="${mf.gname }" class="img-responsive" alt="">
						</a><br/>
						</li>
						...
						<li style="padding-left:100px;"><span class="cost">${mf.grprice }</span></li>
