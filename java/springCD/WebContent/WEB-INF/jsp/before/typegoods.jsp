	...
	<div class="ckeckout">
		<div class="container">
			...
			<div class="in-check" >
				...
				<c:forEach items="${typelist }" var="tl" varStatus="status"> 
				<ul class="cart-header">
						
						<li style="padding-left:100px;"><span class="cost">${tl.id }</span></li>
						
						<li class="ring-in" style="padding-left:100px;">
						<a href="goodsDetail?id=${tl.id}" >
						<img src="images/logos/${tl.gpicture }" title="${tl.gname }" class="img-responsive" alt="">
						</a><br/>
						</li>
						...
						<li style="padding-left:100px;"><span class="cost">${tl.grprice }</span></li>
