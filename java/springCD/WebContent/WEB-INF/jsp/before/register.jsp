		...
		<div class="container">
			...
			<div class="register-main">
				<div class="col-md-6 account-left">
						<input placeholder="请输入E-mail" name="bemail" value="${buser.bemail}" type="text" tabindex="1" required>${msg }
						<input placeholder="请输入密码" name="bpwd" type="password" tabindex="2" required>
						<input placeholder="请确认密码" name="rebpwd" type="password" tabindex="2" required>
						<input placeholder="请输入验证码" name="code" type="text" tabindex="3" required>
						<img id="code" src="validateCode" height="40" width="100"/><br>
				...
				<div class="col-md-6 account-left">
					<h3>Tips :</h3>
					<p>
						1、请使用有效的E-mail地址，以确保第一时间接收到相关服务的信息，以便更好地享受网站服务。<br>
						2、为了您帐户的安全，建议使用字符+数字等多种不同类型的组合，且长度大于5位。<br>
						3、请确保您记住密码。<br>
					</p>
				</div>
				<div class="clearfix"></div>
			...
			<div class="address submit">
				<input type="submit" name="button" value="注册账号">
			</div>
			</form:form>
		</div>
	</div>
