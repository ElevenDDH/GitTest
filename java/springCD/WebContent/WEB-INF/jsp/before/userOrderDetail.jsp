		...
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<tr>
						<th style="height: 60px;text-align: center;">商品编号</th>
						<th style="height: 60px;text-align: center;">商品名称</th>
						<th style="height: 60px;text-align: center;">商品图片</th>
						<th style="height: 60px;text-align: center;">商品价格</th>
						<th style="height: 60px;text-align: center;">购买数量</th>
					</tr>
					<tr>
					...
					<c:forEach var="mf" items="${myOrderDetail}"> 
						<tr>
							<td bgcolor="#ffffff" align="center" style="height: 60px;">${mf.id}</td>
							<td bgcolor="#ffffff"  align="center" style="height: 60px;">${mf.gname}</td>
							<td align="center" bgcolor="#ffffff" style="height: 60px;"> 
							<a href="goodsDetail?id=${mf.id}" >
							<img
									style="width: 50px; height: 50px;"
									src="images/logos/${mf.gpicture}" border="0"
									title="${mf.gname}" /> </a></td>
							<td align="center" bgcolor="#ffffff" style="height: 60px;">${mf.grprice}</td>
							<td align="center" bgcolor="#ffffff" style="height: 60px;">${mf.shoppingnum}</td>
						</tr>
					</c:forEach>
				</table><br>
				<a href="userCenter" class="add-cart item_add" style="float: right;">
