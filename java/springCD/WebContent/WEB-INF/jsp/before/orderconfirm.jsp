...
<script type="text/javascript">
	function submitorder(total){
		if(window.confirm("请确认好信息是否准确无误，提交订单后不可再修改订单信息！")){
			window.location.href="/springCD/order/orderSubmit?amount=" + total;
			return true;
		}
		return false;
	}
		...
		<div class="container">
			<div class="breadcrumbs-main">
				<ol class="breadcrumb">
					...
					<li class="active">  购物流程  / 确认订单信息</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<h3>商品列表</h3>
             ...
             <ul class="unit">
					...
					<li style="padding-left:100px;"><span>市场价格</span></li>		
					<li style="padding-left:100px;"><span>购买数量</span></li>
					<li style="padding-left:100px;"><span>小计</span></li>
				...
				font-size: 20px; font-weight: bold; letter-spacing: 0px;">
				<a onclick="submitorder(${total})" class="add-cart item_add">
				提交订单
				</a>
				</font>
				</span>
