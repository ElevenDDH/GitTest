		...
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<tr>
						<th style="height: 50px;text-align: center;">订单编号</th>
						<th style="height: 50px;text-align: center;">订单金额</th>
						<th style="height: 50px;text-align: center;">订单日期</th>
						<th style="height: 50px;text-align: center;">订单状态</th>
						<th style="height: 50px;text-align: center;">详情</th>
					</tr>
					<tr>
					...
					<c:forEach var="mo" items="${myOrder}"> 
						<tr>
							<td bgcolor="#ffffff" align="center" style="height: 40px;">${mo.id}</td>
							<td bgcolor="#ffffff"  align="center" style="height: 40px;">${mo.amount}</td>
							<td align="center" bgcolor="#ffffff" style="height: 40px;">${mo.orderdate}</td>
							<td bgcolor="#ffffff"  align="center" style="height: 40px;">
							<c:if test="${mo.status == 0}" >
							<font color="#ABABAB">未付款</font>&nbsp;&nbsp;
							<a style="text-decoration: none;" class="f6" href="order/pay?ordersn=${mo.id}">去支付</a>
							</c:if>
							<c:if test="${mo.status == 1}" >已付款</c:if>
							</td>
							<td align="center" bgcolor="#ffffff" style="height: 40px;">
		...
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					cellspacing="1" bgcolor="#dddddd">
					<tr>
						<th style="height: 50px;text-align: center;">商品编号</th>
						<th style="height: 50px;text-align: center;">商品名称</th>
						<th style="height: 50px;text-align: center;">商品图片</th>
						<th style="height: 50px;text-align: center;">商品价格</th>
						<th style="height: 50px;text-align: center;">去看看</th>
					</tr>
					<tr>
						<td colspan="5" height="15px"
							style="border: 0 none; background: #FFF"></td>
					...
					<c:forEach var="mf" items="${myFocus}"> 
						<tr>
							<td bgcolor="#ffffff" align="center" style="height: 40px;">${mf.id}</td>
							<td bgcolor="#ffffff"  align="center" style="height: 40px;width: 200px;padding: 20px;">${mf.gname}</td>
							<td align="center" bgcolor="#ffffff" height="60px" style="height: 40px;width: 200px;padding: 20px;"> <img
									style="width: 50px; height: 50px;"
									src="images/logos/${mf.gpicture}" border="0"
									title="${mf.gname}" /> </td>
							<td align="center" bgcolor="#ffffff" style="height: 40px;">${mf.grprice}</td>
							<td align="center" bgcolor="#ffffff" style="height: 40px;">
								<a  href="goodsDetail?id=${mf.id}">去看看</a>
							</td>
						</tr>
					</c:forEach>
				</table><br><br><br>
